...
{
    public partial class AddQuestionAndOptionAndSpecialtyTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Question_Question_NextQuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Option_Question_NextQuestionId",
                        column: x => x.NextQuestionId,
                        principalTable: "Question",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Option_Specialty_SpecialtyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Question_NextQuestionId",
                table: "Question",
                column: "NextQuestionId");
