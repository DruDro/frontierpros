...
namespace FrontierPros.Data.Migrations
{
    ...
    [Migration("20190612125727_RenamedGroupIdColumnToServiceCategoryIdForServiceCategoryAndServiceInfoTable")]
    partial class RenamedGroupIdColumnToServiceCategoryIdForServiceCategoryAndServiceInfoTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FrontierPros.Core.Domain.Sources.AddonSource", b =>
                {
                    ...
                    b.Property<int>("CategoryInfoSourceId");

                    b.Property<string>("Name");

                    b.HasKey("Id");

                    b.HasIndex("CategoryInfoSourceId");
            ...
            modelBuilder.Entity("FrontierPros.Core.Domain.Sources.ServiceCategorySourceAndServiceInfoSource", b =>
                {
                    ...
                    b.Property<int>("GroupSourceId");

                    b.HasKey("Id");

                    b.HasIndex("CategoryInfoSourceId");

                    b.HasIndex("GroupSourceId");
            ...
            modelBuilder.Entity("FrontierPros.Core.Domain.Catalog.ServiceInfoAndNameToken", b =>
                {
                    b.HasOne("FrontierPros.Core.Domain.Catalog.ServiceInfo", "CategoryInfo")
                        .WithMany("NameTokens")
            ...
            modelBuilder.Entity("FrontierPros.Core.Domain.Services.Service", b =>
                {
                    b.HasOne("FrontierPros.Core.Domain.Catalog.ServiceInfo", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryInfoId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("FrontierPros.Core.Domain.Sources.AddonSource", b =>
                {
                    b.HasOne("FrontierPros.Core.Domain.Sources.ServiceInfoSource", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryInfoSourceId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("FrontierPros.Core.Domain.Sources.ProviderQuestionSource", b =>
                {
                    b.HasOne("FrontierPros.Core.Domain.Sources.ServiceInfoSource", "CategoryInfo")
                        .WithMany()
                        .HasForeignKey("CategoryInfoSourceId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("FrontierPros.Core.Domain.Sources.ServiceCategorySourceAndServiceInfoSource", b =>
                {
                    ...
                    b.HasOne("FrontierPros.Core.Domain.Sources.ServiceCategorySource", "Group")
                        .WithMany()
                        .HasForeignKey("GroupSourceId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
