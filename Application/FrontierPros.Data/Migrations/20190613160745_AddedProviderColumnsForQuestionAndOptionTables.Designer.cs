...
namespace FrontierPros.Data.Migrations
{
    ...
    [Migration("20190613160745_AddedProviderColumnsForQuestionAndOptionTables")]
    partial class AddedProviderColumnsForQuestionAndOptionTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FrontierPros.Core.Domain.Questions.ProviderOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("ProviderOption");
                });

            modelBuilder.Entity("FrontierPros.Core.Domain.Questions.ProviderQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int?>("ClientQuestionId");
                    ...
                    b.HasIndex("ClientQuestionId");

                    b.HasIndex("NextQuestionId");

                    b.HasIndex("ServiceInfoId");

                    b.ToTable("ProviderQuestion");
                });
            ...
            modelBuilder.Entity("FrontierPros.Core.Domain.Services.ProviderOptionPrice", b =>
                {
                    ...
                    b.Property<int>("ProviderOptionId");

                    b.Property<int>("ServiceId");

                    b.HasKey("Id");

                    b.HasIndex("ProviderOptionId");
            ...
            modelBuilder.Entity("FrontierPros.Core.Domain.Services.Service", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FrontierPros.Core.Domain.Sources.ProviderOptionSource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int?>("ClientOptionSourceId");
                    ...
                    b.HasIndex("ClientOptionSourceId");

                    b.HasIndex("QuestionSourceId");

                    b.HasIndex("SpecialtySourceId");

                    b.ToTable("ProviderOptionSource");
                });

            modelBuilder.Entity("FrontierPros.Core.Domain.Sources.ProviderQuestionSource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int?>("ClientQuestionSourceId");
                    ...
                    b.HasIndex("ClientQuestionSourceId");

                    b.HasIndex("NextQuestionSourceId");

                    b.HasIndex("ServiceInfoSourceId");

                    b.ToTable("ProviderQuestionSource");
                });
            ...
            modelBuilder.Entity("FrontierPros.Core.Domain.Questions.ProviderOption", b =>
                {
                    b.HasOne("FrontierPros.Core.Domain.Questions.Option", "ClientOption")
                        .WithMany()
                        .HasForeignKey("ClientOptionId");

                    b.HasOne("FrontierPros.Core.Domain.Questions.ProviderQuestion", "Question")
                        .WithMany("Options")
                        .HasForeignKey("QuestionId");
            ...
            modelBuilder.Entity("FrontierPros.Core.Domain.Questions.ProviderQuestion", b =>
                {
                    b.HasOne("FrontierPros.Core.Domain.Questions.Question", "ClientQuestion")
                        .WithMany()
                        .HasForeignKey("ClientQuestionId");

                    b.HasOne("FrontierPros.Core.Domain.Questions.ProviderQuestion", "NextQuestion")
                        .WithMany()
                        .HasForeignKey("NextQuestionId");
            ...
            modelBuilder.Entity("FrontierPros.Core.Domain.Services.ProviderOptionPrice", b =>
                {
                    b.HasOne("FrontierPros.Core.Domain.Questions.ProviderOption", "ProviderOption")
                        .WithMany()
                        .HasForeignKey("ProviderOptionId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("FrontierPros.Core.Domain.Services.Service", "Service")
                        .WithMany("Prices")
            ...
            modelBuilder.Entity("FrontierPros.Core.Domain.Sources.ProviderOptionSource", b =>
                {
                    b.HasOne("FrontierPros.Core.Domain.Sources.OptionSource", "ClientOption")
                        .WithMany()
                        .HasForeignKey("ClientOptionSourceId");

                    b.HasOne("FrontierPros.Core.Domain.Sources.ProviderQuestionSource", "Question")
                        .WithMany("Options")
                        .HasForeignKey("QuestionSourceId");
            ...
            modelBuilder.Entity("FrontierPros.Core.Domain.Sources.ProviderQuestionSource", b =>
                {
                    b.HasOne("FrontierPros.Core.Domain.Sources.QuestionSource", "ClientQuestion")
                        .WithMany()
                        .HasForeignKey("ClientQuestionSourceId");

                    b.HasOne("FrontierPros.Core.Domain.Sources.ProviderQuestionSource", "NextQuestion")
                        .WithMany()
                        .HasForeignKey("NextQuestionSourceId");
