...
namespace Nop.Plugin.ExternalAuth.ActiveDirectory.Infrastructure.Cache
{
    /// <summary>
    /// ActiveDirectory authentication event consumer (used for saving customer fields on registration)
    /// </summary>
    public partial class ActiveDirectoryAuthenticationEventConsumer : IConsumer<CustomerAutoRegisteredByExternalMethodEvent>
    {
        #region Fields
        ...
        public ActiveDirectoryAuthenticationEventConsumer(IGenericAttributeService genericAttributeService)
        {
        ...
        public void HandleEvent(CustomerAutoRegisteredByExternalMethodEvent eventMessage)
        {
            ...
            if (!eventMessage.AuthenticationParameters.ProviderSystemName.Equals(ActiveDirectoryAuthenticationDefaults.ProviderSystemName))
                return;
