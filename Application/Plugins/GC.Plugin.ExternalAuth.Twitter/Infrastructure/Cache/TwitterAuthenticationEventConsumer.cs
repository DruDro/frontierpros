...
namespace Nop.Plugin.ExternalAuth.Twitter.Infrastructure.Cache
{
    /// <summary>
    /// Twitter authentication event consumer (used for saving customer fields on registration)
    /// </summary>
    public partial class TwitterAuthenticationEventConsumer : IConsumer<CustomerAutoRegisteredByExternalMethodEvent>
    {
        #region Fields
        ...
        public TwitterAuthenticationEventConsumer(IGenericAttributeService genericAttributeService)
        {
        ...
        public void HandleEvent(CustomerAutoRegisteredByExternalMethodEvent eventMessage)
        {
            ...
            if (!eventMessage.AuthenticationParameters.ProviderSystemName.Equals(TwitterAuthenticationDefaults.ProviderSystemName))
                return;
