...
using FrontierPros.Services.ServiceProviders;
...
namespace Nop.Web.Framework.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
			...
			builder.Register(context => new FrontierProsObjectContext(context.Resolve<DbContextOptions<FrontierProsObjectContext>>()))
				.As<IDbContext>().InstancePerLifetimeScope();
			...
			builder.RegisterType<ServiceInfoSourceService>().As<IServiceInfoSourceService>().InstancePerLifetimeScope();
			builder.RegisterType<ServiceCategoryService>().As<IServiceCategoryService>().InstancePerLifetimeScope();
			builder.RegisterType<ServiceCategorySourceService>().As<IServiceCategorySourceService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<CodeVerificationService>().As<ICodeVerificationService>().InstancePerLifetimeScope();
			builder.RegisterType<CoverageAreaService>().As<ICoverageAreaService>().InstancePerLifetimeScope();
			builder.RegisterType<TimeZoneDataService>().As<ITimeZoneDataService>().InstancePerLifetimeScope();
			builder.RegisterType<AzureBlobStorageService>().As<IBlobStorageService>().InstancePerLifetimeScope();
			builder.RegisterType<StorageService>().As<IStorageService>().InstancePerLifetimeScope();
			builder.RegisterType<ServiceItemMediaFileService>().As<IServiceItemMediaFileService>().InstancePerLifetimeScope();
			builder.RegisterType<CustomerMediaFileService>().As<ICustomerMediaFileService>().InstancePerLifetimeScope();
			builder.RegisterType<B2CGraphService>().As<IB2CGraphService>().InstancePerLifetimeScope();
			builder.RegisterType<ExtendedWorkflowMessageService>().As<IExtendedWorkflowMessageService>().InstancePerLifetimeScope();
			...
			builder.RegisterType<ProviderReviewService>().As<IProviderReviewService>().InstancePerLifetimeScope();
