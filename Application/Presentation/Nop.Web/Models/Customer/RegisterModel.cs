...
{
	[Validator(typeof(MemberRegisterValidator))]
	public class MemberRegisterModel : RegisterModel
	{
        public string Country { get; set; }
        public string Name { get; set; }
    }

	[Validator(typeof(ProviderRegisterValidator))]
	public class ProviderRegisterModel : RegisterModel
	{
	}
