...
{
	public class ProviderRegisterValidator : BaseNopValidator<ProviderRegisterModel>
	{
		public ProviderRegisterValidator(ILocalizationService localizationService,
