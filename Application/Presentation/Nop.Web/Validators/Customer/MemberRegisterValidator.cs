...
{
	public class MemberRegisterValidator : BaseNopValidator<MemberRegisterModel>
	{
		public MemberRegisterValidator(ILocalizationService localizationService,
			...
			CustomerSettings customerSettings)
		{
			...
			RuleFor(x => x.Email).Must((x, context) =>
			{
				...
				return true;
			}).WithMessage(localizationService.GetResource("Account.EmailUsernameErrors.EmailAlreadyExists"));
            ...
            RuleFor(x => x.Country).NotEmpty().WithMessage("Please enter the country.");
