		...
		v-flex.tabs-main
			...
			v-layout.tabs-footer(row wrap justify-space-between align-center mt-5 )
				...
				v-flex(xs12 sm3 md2 style="position:relative")
					button.btn.primary.custom.large.full-width.text-capitalize(@click="saveServiceItem") save
    ...
    computed: {
        tabs() {
            return [
                ...
                // },
                {
                    to: `/provider/services/${this.serviceId}/service-info`,
                    title: "Info"
                },
                // { to: `/services/${this.serviceId}/service-inventory`, title: "Inventory" },
                {
                    to: `/provider/services/${this.serviceId}/service-price`,
                    title: "Price"
                }
