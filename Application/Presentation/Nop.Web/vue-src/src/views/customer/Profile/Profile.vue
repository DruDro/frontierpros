...
export default {
    ...
    computed: {
        tabs() {
            return [
                {
                    to: "/customer/profile/general-info",
                    title: "General Info",
                    hidden: this.$vuetify.breakpoint.width >= 1024
                },
                { to: "/customer/profile/business-summary", title: "Business Summary" },
                {
                    to: "/customer/profile/professional-license",
                    title: "Professional License"
                },
                { to: "/customer/profile/reviews", title: "Reviews" },
                { to: "/customer/profile/photo-video", title: "Photo & Video" }
            ];
        }
    },
    methods: {
